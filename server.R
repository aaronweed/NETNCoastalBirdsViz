...
shinyServer(function(input,output,session){
  ...
  DataOpts<-reactiveValues(Island=NA, Species=NA, Survey=NA, Years=NA)
  
  #### UI Controls ####  
  
  #### Time Series Controls ####
  TimeIsl<-callModule(IslChooser, id="TimeIsl", data=WaterData, chosen=reactive(DataOpts$Island))
  TimeSpecies<-callModule(SpeciesChooser, id="TimeSpecies", data=WaterData, Island=reactive(DataOpts$Island), chosen=reactive(DataOpts$Species))
  TimeSurvey<-callModule(paramChooser, id="TimeSurvey",data=WaterData, Island=reactive(DataOpts$Island), Species=reactive(DataOpts$Species), 
                        chosen=reactive(DataOpts$Survey_Class))
